...
class SynergiesDef(XlsxDataReplace):
    dataSets = [
        {
            'sheetName':'def_leader_skills',
            'firstColumn':1,
            'firstRow':2,
            'sql':"""
            select mn.full_name
        ...
        },    
        {
            ...
            'sql':"""
                ...
                where mn.awaken_level >= 1
                and mn.awakens_to is null
                and (s2.multiplier_formula like '%DEF%'
                  or s3.multiplier_formula like '%DEF%')
                order by mn.natural_stars desc
                , mn.full_name;
            """
        },          
